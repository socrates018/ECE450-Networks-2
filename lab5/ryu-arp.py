...
class SimpleSwitch(app_manager.RyuApp):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.mac_to_port = {}
        # Define static IP/MAC mapping for the two hosts
        self.ip_to_mac = {
            "10.0.0.1": "00:00:00:00:00:01",
            "10.0.0.2": "00:00:00:00:00:02"
        }
        self.mac_to_port_static = {
            "00:00:00:00:00:01": 1,
            "00:00:00:00:00:02": 2
        }
    ...
    def spoof_arp_reply(self, datapath, eth, arp_pkt, target_ip, in_port):
    ...
    def switch_features_handler(self, ev):
        ...
        # ...existing code for static flows...
    ...
    def _packet_in_handler(self, ev):
        ...
        # ARP reply logic: switch replies directly to ARP requests for known IPs
        if eth is not None and ethertype == ether_types.ETH_TYPE_ARP and arp_pkt and arp_pkt.opcode == arp.ARP_REQUEST:
